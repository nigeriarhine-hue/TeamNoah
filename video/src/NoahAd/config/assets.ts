...
export const assets = {
  ...
  pane: {
    ...
    planTyped: staticFile('noah/pane-plan-typed.png'),
  ...
  crop: {
    ...
    talkNote: staticFile('noah/crop-talk-note.png'),
    typed: staticFile('noah/crop-typed.png'),
    dialog: staticFile('noah/crop-dialog.png'),
    sent: staticFile('noah/crop-sent.png'),
