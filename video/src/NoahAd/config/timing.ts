...
export const cues = {
  ...
  showFix: scenes.approval.start + s(1.15),
  hover: scenes.approval.start + s(2.0),
  clickAction: scenes.approval.start + s(2.3),
  dialog: scenes.approval.start + s(2.75),
  clickApprove: scenes.approval.start + s(3.95),
  approved: scenes.approval.start + s(4.15),
